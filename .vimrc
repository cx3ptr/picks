...
"s Setting up Vundle - the vim plugin bundler
let iCanHazVundle=1
...
" Code commenter, mapleader=\
Bundle 'scrooloose/nerdcommenter'
" Class/module/variable browser
Bundle 'majutsushi/tagbar'
" Code and files fuzzy finder
Bundle 'kien/ctrlp.vim'
" Extension to ctrlp, for fuzzy command finder
Bundle 'fisadev/vim-ctrlp-cmdpalette'
" Zen coding(html),triger: <c-y>,
...
" Pending tasks list, like TODO,FIXME, triger: :TaskList
...
"ycm setting
let g:ycm_global_ycm_extra_conf='/Users/bigpyer/.vim/bundle/YouCompleteMe/third_party/ycmd/cpp/ycm/.ycm_extra_conf.py'
